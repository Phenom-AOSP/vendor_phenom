...
PRODUCT_COPY_FILES += \
    vendor/phenom/prebuilt/common/etc/init.d/50selinuxrelabel:system/etc/init.d/50selinuxrelabel
...
PRODUCT_COPY_FILES += \
    vendor/phenom/prebuilt/common/etc/mkshrc:system/etc/mkshrc \
    vendor/phenom/prebuilt/common/etc/sysctl.conf:system/etc/sysctl.conf
...
PRODUCT_COPY_FILES += \
    ...
    vendor/phenom/prebuilt/common/etc/init.d/90userinit:system/etc/init.d/90userinit \
    vendor/phenom/prebuilt/common/bin/sysinit:system/bin/sysinit
...
PRODUCT_COPY_FILES += \
    vendor/phenom/prebuilt/common/bootanimation/halfres/$(TARGET_BOOTANIMATION_NAME).zip:system/media/bootanimation.zip
else
PRODUCT_COPY_FILES += \
    vendor/phenom/prebuilt/common/bootanimation/$(TARGET_BOOTANIMATION_NAME).zip:system/media/bootanimation.zip
endif
endif
...
EXTENDED_POST_PROCESS_PROPS := vendor/phenom/tools/phenom_process_props.py
