...
DEBUG = False
default_manifest = ".repo/manifests/phenom_default.xml"
custom_local_manifest = ".repo/local_manifests/phenom_manifest.xml"
custom_default_revision = "8.0"
custom_dependencies = "phenom.dependencies"
org_manifest = "PHENOM-Devices"  # leave empty if org is provided in manifest
org_display = "PHENOM-Devices"  # needed for displaying
